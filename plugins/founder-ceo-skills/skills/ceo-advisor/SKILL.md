---
name: ceo-advisor
description: Comprehensive CEO advisory spanning strategy, capital, organization, board governance, and leadership. Use only when the user explicitly asks for "CEO 综合建议", a comprehensive CEO review, or broad cross-domain CEO advisory. Do not trigger for a single specialized topic when another Founder/CEO skill applies.
license: MIT
metadata:
  version: 1.0.0
