...
description: Reduce voluntary and involuntary churn through retention analysis, cancellation flows, save offers, pause options, exit research, dunning, failed-payment recovery, and win-back systems.
---
...
| Approaching plan limit | Contextual upgrade nudge without blocking core value |
...
**How to run cancel flow experiments:** Use **growth-experiments** to design statistically rigorous tests. A feature-flag and funnel-analytics tool can split users into different flows server-side and track survey → offer → accept/decline → confirm.
...
- **customer-research**: For churn reasons and exit evidence
- **analytics**: For setting up churn signal events
- **growth-experiments**: For testing cancel flow variations with statistical rigor
