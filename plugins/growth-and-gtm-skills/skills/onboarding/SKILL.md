---
name: onboarding
description: Improve post-signup onboarding, activation, first-run experience, empty states, aha moments, and time to value. Use when users sign up but do not complete setup, activate, or return.
---
...
- **cro**: For friction before account creation
- **analytics**: For activation funnels and cohorts
- **customer-research**: For finding the real aha moment
- **churn-prevention**: For later retention
- **growth-experiments**: For testing onboarding changes
