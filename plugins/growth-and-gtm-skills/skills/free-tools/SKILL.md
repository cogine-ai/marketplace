---
name: free-tools
description: Plan, evaluate, or build a useful free calculator, generator, grader, audit, or interactive resource for lead generation, search demand, backlinks, or brand awareness. Use for engineering-as-marketing opportunities.
---
...
- **search-visibility**: For demand discovery and search optimization
- **analytics**: For measuring tool usage
- **content-strategy**: For distributing and repurposing the tool
