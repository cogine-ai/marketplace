...
- [AI Writing Detection](ai-writing-detection.md): Common AI writing patterns to avoid
...
- For AI search optimization, return to **search-visibility** and load **ai-search.md**
...
- **search-visibility**: For AI discovery and scaled search pages
