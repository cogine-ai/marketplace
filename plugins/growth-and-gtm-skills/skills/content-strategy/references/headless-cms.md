...
Use CMS as the data source for programmatic pages. Store structured data (FAQs, comparisons, city pages) as content types and generate pages from queries. See **search-visibility** skill.
...
content is organized in the CMS. Plan the content model and site architecture
together, then use **search-visibility** to validate discoverability.
