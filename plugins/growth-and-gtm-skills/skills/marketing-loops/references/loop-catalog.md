...
- **Skills used**: `search-visibility`, `content-strategy`
- **Loop body**:
...
- **Skills used**: `search-visibility`, `analytics`
- **Loop body**:
...
- **Skills used**: `copywriting`, `search-visibility`, `content-strategy`
- **Loop body**:
...
- **Skills used**: `content-strategy`, `copywriting`
- **Loop body**:
...
- **Skills used**: `content-strategy`, `search-visibility`
- **Loop body**:
...
- **Skills used**: `acquisition-channels`, `copywriting`, `analytics`
- **Loop body**:
...
- **Skills used**: `copywriting`, `customer-research`
- **Loop body**:
...
- **Acts when**: The account had meaningful creative activity last month — new concepts launched with enough delivery to judge (respect the impression/spend thresholds in `acquisition-channels`). If nothing launched or nothing cleared thresholds, note that and skip.
...
- **Skills used**: `copywriting`, `acquisition-channels`, `analytics`
- **Loop body**:
...
- **Skills used**: `acquisition-channels`, `analytics`
- **Loop body**:
...
- **Skills used**: `launch`, `content-strategy`
- **Loop body**:
...
- **Skills used**: `content-strategy`, `customer-research`
- **Loop body**:
...
- **Skills used**: `customer-research`, `content-strategy`
- **Loop body**:
...
- **Skills used**: `competitors`, `product-marketing`
- **Loop body**:
...
- **Skills used**: `launch`, `search-visibility`
- **Loop body**:
...
- **Skills used**: `acquisition-channels`
- **Loop body**:
...
- **Skills used**: `cro`, `analytics`, `growth-experiments`
- **Loop body**:
  ...
  3. Draft a hypothesis + test for the worst step (hand test execution to `growth-experiments`).
...
- **Output**: A prioritized experiment brief for `growth-experiments`.
...
- **Skills used**: `content-strategy`, `free-tools`, `cro`
- **Loop body**:
...
- **Skills used**: `onboarding`, `copywriting`, `analytics`
- **Loop body**:
...
- **Skills used**: `churn-prevention`, `analytics`, `copywriting`
- **Loop body**:
...
- **Skills used**: `copywriting`, `analytics`
- **Loop body**:
...
- **Skills used**: `copywriting`, `pricing`
- **Loop body**:
...
- **Skills used**: `customer-research`, `churn-prevention`, `acquisition-channels`, `copywriting`
- **Loop body**:
  1. Collect new feedback across sources.
  2. Route: detractors/at-risk → save motion (`churn-prevention`); promoters → referral/review ask (`acquisition-channels`); recurring pain/desire → experiment + copy inputs.
...
- **Skills used**: `copywriting`, `pricing`, `analytics`
- **Loop body**:
...
- **Skills used**: `analytics`, `product-marketing`
- **Loop body**:
...
- **Skills used**: `pricing`, `growth-experiments`, `cro`
- **Loop body**:
  ...
  3. Hand design/analysis to `growth-experiments`; promote a clean winner.
...
- **Skills used**: `pricing`, `growth-experiments`, `analytics`
- **Loop body**:
  ...
  3. Hand execution to `growth-experiments`.
...
- **Skills used**: `analytics`, `product-marketing`, `copywriting`
- **Loop body**:
...
- **Skills used**: `analytics`, `copywriting`
- **Loop body**:
...
- **Skills used**: `acquisition-channels`, `copywriting`
- **Loop body**:
...
- **Skills used**: `content-strategy`, `acquisition-channels`, `product-marketing`, `cro`
- **Loop body**:
...
- **Skills used**: `product-marketing`, `content-strategy`, `cro`
- **Loop body**:
...
- **Skills used**: `product-marketing`, `customer-research`, `acquisition-channels`
- **Loop body**:
...
- **Skills used**: `analytics`, `product-marketing`, `content-strategy`
- **Loop body**:
...
- **Purpose**: Keep the experiment pipeline full and prioritized. **Thin wrapper — defer all test design, statistical analysis, and velocity management to `growth-experiments`.**
- **Skills used**: `growth-experiments` (owner), `cro`, `analytics`
- **Loop body**:
  1. Harvest new hypotheses from the week (data, research, competitors, support, other loops).
  2. Re-rank the backlog with ICE.
  3. If a slot is free, hand the top idea to `growth-experiments`; if a test concluded there, log the learning.
...
- **Stop / bail-out**: Backlog full and a test running → just log new ideas. Don't duplicate `growth-experiments`'s job.
- **Output**: An updated, ranked backlog (the source of record lives with `growth-experiments`).
...
- **Skills used**: `content-strategy`, `launch`
- **Loop body**:
