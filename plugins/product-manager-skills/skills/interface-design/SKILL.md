...
- **Design review** — run a strict craft and hierarchy review with an approval bar; render before and after when possible.
- **Design deslop** — run a fast, diff-scoped pass that removes visual slop from the current branch.
