...
**Access**: Use its UI, API, or an available connector.
...
**Access**: Use their UIs, APIs, or available connectors.
...
**Access**: Use public pages, the GitHub API, or an available connector.
...
**Access**: Use either service only when it is available and permitted.
