...
| **Demand-signal** | Early-stage: your first customers, design partners, or beta users | Evidence of the exact pain/demand/timing signal — a cited public source, not just firmographic fit | Forums, communities, reviews, GitHub issues, job posts, launch announcements |
...
Use the web, files, enrichment services, or CRM data that are actually
available. Do not require a particular vendor. Preserve a source URL or record
reference for every material claim, distinguish verified facts from inferred
fit, and never send outreach or mutate CRM records without approval.
...
- **account-research**: For deeper research on one selected account
- **first-b2b-customers**: For design-partner and first-customer strategy
- **sales-enablement**: For battle cards and one-pagers used in the outreach
- **pipeline-review**: For prioritizing qualified opportunities after handoff
