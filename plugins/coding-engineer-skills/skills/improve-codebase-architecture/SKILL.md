...
Once the user picks a candidate, use the `coding-engineer-skills:grilling` skill to walk the decision tree with them: constraints, dependencies, the shape of the deepened module, what sits behind the seam, what tests survive.
